from vspace import VSpaceDriver, VSpaceInput
import numpy
...
class DataLogger(VSpaceDriver):
    ...
    def port_connected(self, port_id, connected_to_id):
        ...
        self._datasets[self._gvarspace.get_port_info(port_id)['portname']] = {
            ...
            'source': '{}.{}'.format(port_info['instname'], port_info['portname'])
        }

        self.log_info('now logging value of "{}.{}"'.format(port_info['instname'], port_info['portname']))
    ...
    def update_local_variable(self, variable_name, new_value):
        ...
        numpy.append(self._datasets[variable_name]['xdata'], numpy.datetime64(datetime.now()))
